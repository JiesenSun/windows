 ...
 */
var (
	CLIENT_ERR_NO_ERROR       = New("0")
	CLIENT_ERR_UNKNOW_ERROR   = New("1")
	CLIENT_ERR_USER_NOT_EXIST = New("2")
	CLIENT_ERR_PASSWORD_ERROR = New("3")
	CLIENT_ERR_LOGIN_CONFLICT = New("4")
	// register
	CLIENT_ERR_USER_EXIST = New("5")
)
